...
public class AudioSourceBank {
    ...
    private static string[] availableEffects = { "LowPassSource", "ReverbSource", "EchoSource", "DistortionSource", "ChorusSource", "PitchShiftSource", "HighPassSource", "FlangeSource" };
